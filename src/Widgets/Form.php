...
namespace DanSketic\Backport\Widgets;

use Closure;
use DanSketic\Backport\Facades\Backport;
use DanSketic\Backport\Form as BaseForm;
...
$('form#{$id}').off('submit').on('submit', function (e) {
    e.preventDefault();
    var form = this;
    $.backport.swal($settings).then(function (result) {
...
SCRIPT;
    ...
    public function render()
    {
        ...
        $form = view('backport::widgets.form', $this->getVariables())->render();
