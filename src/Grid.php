...
use DanSketic\Backport\Grid\Concerns;
...
use DanSketic\Backport\Traits\ShouldSnakeAttributes;
...
class Grid
{
     ...
     *
     * @var \DanSketic\Backport\Grid\Model|\Illuminate\Database\Eloquent\Builder
     */
    protected $model;
     ...
     * @var string
     */
    protected $view = 'backport::grid.table';
    ...
    public static function registerColumnDisplayer()
    {
        $map = [
            ...
            'imageText'   => Displayers\ImageText::class,
    ...
    public function render()
    {
        ...
        return Backport::component($this->view, $this->variables());
