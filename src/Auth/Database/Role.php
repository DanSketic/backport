...
class Role extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('backport.database.roles_table'));
    ...
    public function administrators(): BelongsToMany
    {
        ...
        $relatedModel = config('backport.database.users_model');
    ...
    {
        $pivotTable = config('backport.database.role_permissions_table');
    ...
    public function menus(): BelongsToMany
    {
        ...
        $relatedModel = config('backport.database.menu_model');
