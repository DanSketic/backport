...
class InstallCommand extends Command
{
    ...
    public function initDatabase()
    {
        ...
        if ($userModel::count() == 0) {
            $this->call('db:seed', ['--class' => \DanSketic\Backport\Auth\Database\AdminTablesSeeder::class]);
        }
    }
    ...
    {
        $this->directory = config('backport.directory');
    ...
    public function createHomeController()
    {
        ...
        $this->laravel['files']->put(
            $homeController,
            str_replace('DummyNamespace', config('backport.route.namespace'), $contents)
        );
    ...
    protected function createRoutesFile()
    {
        ...
        $this->laravel['files']->put($file, str_replace('DummyNamespace', config('backport.route.namespace'), $contents));
