...
class PermissionCommand extends Command
{
    ...
    {
        return [
            config('backport.database.users_table'),
            config('backport.database.roles_table'),
            config('backport.database.permissions_table'),
            config('backport.database.menu_table'),
            config('backport.database.operation_log_table'),
            config('backport.database.user_permissions_table'),
            config('backport.database.role_users_table'),
            config('backport.database.role_permissions_table'),
            config('backport.database.role_menu_table'),
        ];
    }
    ...
    {
        return [
            'list'   => __('backport.list'),
            'view'   => __('backport.view'),
            'create' => __('backport.create'),
            'edit'   => __('backport.edit'),
            'delete' => __('backport.delete'),
            'export' => __('backport.export'),
            'filter' => __('backport.filter'),
        ];
    }
