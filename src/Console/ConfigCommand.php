...
class ConfigCommand extends Command
{
    ...
    {
        $path = $this->argument('path') ?: 'config/backport.php';

        $current = require $path;
        $original = require __DIR__.'/../../config/backport.php';
        ...
        $this->line('');
        $this->comment('Please open `vendor/encore/backport/config/backport.php` to check the difference');
    }
