...
use DanSketic\Backport\Settings\Builder;
use DanSketic\Backport\Settings\Field;
use DanSketic\Backport\Form\Row;
use DanSketic\Backport\Settings\Tab;
 ...
 */
class Settings implements Renderable
{
    /**
     ...
     */
    protected function redirectAfterSaving($resourcesPath, $key = null)
    {
        $url = $resourcesPath;
...
//        static::doNotSnakeAttributes($this->model);
    ...
    public static function registerBuiltinFields()
    {
        $map = [
            ...
            'id'             => Field\Id::class,
            'image'          => Field\Avatar::class,
            'image_settings' => Field\Avatar::class,
            'ip'             => Field\Ip::class,
            'map'            => Field\Map::class,
            ...
            'toggle'         => Field\SwitchField::class,
