...
use DanSketic\Backport\Widgets\Form as WidgetForm;
...
class HasMany extends Field
{
     ...
     */
    protected $views = [
        'default' => 'backport::form.hasmany',
        'tab'     => 'backport::form.hasmanytab',
        'table'   => 'backport::form.hasmanytable',
    ];
...
EOT;
    ...
    protected function renderTable()
    {
        ...
        foreach ($this->buildNestedForm($this->column, $this->builder)->fields() as $field) {
            ...
            /*
             * Get and remove the last script of Backport::$script stack.
             */
            if ($field->getScript()) {
                $scripts[] = array_pop(Backport::$script);
            }
        }
