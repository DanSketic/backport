...
class Listbox extends MultipleSelect
{
    ...
    protected static $css = [
        '/vendor/backport/bootstrap-duallistbox/dist/bootstrap-duallistbox.min.css',
    ];

    protected static $js = [
        '/vendor/backport/bootstrap-duallistbox/dist/jquery.bootstrap-duallistbox.min.js',
    ];
