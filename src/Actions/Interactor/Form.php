...
namespace DanSketic\Backport\Actions\Interactor;
...
class Form extends Interactor
{
    ...
    public function email($column, $label = '')
    {
        ...
        $this->addField($field)->setView('backport::actions.form.text');
    ...
    public function image($column, $label = '')
    {
        ...
        $this->addField($field)->setView('backport::actions.form.file');
    ...
    public function multipleImage($column, $label = '')
    {
        ...
        $this->addField($field)->setView('backport::actions.form.muitplefile');
    ...
    protected function resolveView($class)
    {
        ...
        return "backport::actions.form.{$name}";
    }
    ...
    public function addModalHtml()
    {
        ...
        $modal = view('backport::actions.form.modal', $data)->render();
