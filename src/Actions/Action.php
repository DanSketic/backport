...
var actionResolver = function (data) {
            ...
            if (typeof response !== 'object') {
                return $.backport.swal({type: 'error', title: 'Oops!'});
            }
            ...
            if (typeof response.swal === 'object') {
                $.backport.swal(response.swal);
            }

            if (typeof response.toastr === 'object' && response.toastr.type) {
                $.backport.toastr[response.toastr.type](response.toastr.content, '', response.toastr.options);
            }
        ...
        var actionCatcher = function (request) {
            if (request && typeof request.responseJSON === 'object') {
                $.backport.toastr.error(request.responseJSON.message, '', {positionClass:"toast-bottom-center", timeOut: 10000}).css("width","500px")
            }
        };
SCRIPT;

        Backport::script($resolve);
