...
use DanSketic\Backport\Actions\Action;
use DanSketic\Backport\Actions\GridAction;
use DanSketic\Backport\Actions\Response;
use DanSketic\Backport\Actions\RowAction;
use DanSketic\Backport\Widgets\Form;
use Exception;
...
class HandleController extends Controller
{
    ...
    public function handleSelectable(Request $request)
    {
        ...
        if (class_exists($class)) {
            /** @var \DanSketic\Backport\Grid\Selectable $selectable */
