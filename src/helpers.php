...
if (!function_exists('admin_path')) {
    ...
    {
        return ucfirst(config('backport.directory')).($path ? DIRECTORY_SEPARATOR.$path : $path);
    }
}
...
if (!function_exists('admin_url')) {
    ...
    function admin_url($path = '', $parameters = [], $secure = null)
    {
        ...
        $secure = $secure ?: (config('backport.https') || config('backport.secure'));
...
if (!function_exists('admin_base_path')) {
    ...
    {
        $prefix = '/'.trim(config('backport.route.prefix'), '/');
...
if (!function_exists('admin_asset')) {
    ...
    {
        return (config('backport.https') || config('backport.secure')) ? secure_asset($path) : asset($path);
    }
}
...
if (!function_exists('admin_get_route')) {
    ...
    {
        return config('backport.route.prefix').'.'.$name;
    }
}
