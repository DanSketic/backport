...
use DanSketic\Backport\Auth\Database\Menu;
...
class MenuTest extends TestCase
{
    ...
    public function testAddMenu()
    {
        ...
        $this->visit('admin/auth/menu')
            ...
            ->seePageIs('admin/auth/menu')
            ->seeInDatabase(config('backport.database.menu_table'), $item)
    ...
    public function testEditMenu()
    {
        $this->visit('admin/auth/menu/1/edit')
            ...
            ->seePageIs('admin/auth/menu')
            ->seeInDatabase(config('backport.database.menu_table'), ['title' => 'blablabla'])
            ->assertEquals(7, Menu::count());
    }
