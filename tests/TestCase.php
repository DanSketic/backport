...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->register('DanSketic\Backport\BackportServiceProvider');
    ...
    protected function setUp(): void
    {
        ...
        $adminConfig = require __DIR__.'/config/backport.php';
        ...
        $this->artisan('vendor:publish', ['--provider' => 'DanSketic\Backport\BackportServiceProvider']);
...
//        \DanSketic\Backport\Backport::$css = [];
//        \DanSketic\Backport\Backport::$js = [];
//        \DanSketic\Backport\Backport::$script = [];
    }
