<div class="dropdown pull-right column-selector">
    ...
    <ul class="dropdown-menu" role="menu">
        ...
        <li class="divider"></li>
        <li class="text-right">
            <button class="btn btn-sm btn-default column-select-all">{{ __('backport.all') }}</button>&nbsp;&nbsp;
            <button class="btn btn-sm btn-primary column-select-submit">{{ __('backport.submit') }}</button>
        </li>
    </ul>
</div>
