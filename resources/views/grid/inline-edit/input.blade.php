@extends('backport::grid.inline-edit.comm')
...
@section('assert')
    <script>
        @component('backport::grid.inline-edit.partials.popover', compact('trigger'))
            @slot('content')
    ...
    {{--after submit--}}
    <script>
    @component('backport::grid.inline-edit.partials.submit', compact('resource', 'name'))
