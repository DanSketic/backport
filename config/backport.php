...
return [
    ...
    */
    'auth' => [
        ...
        'providers' => [
            'backport' => [
                'driver' => 'eloquent',
                'model'  => DanSketic\Backport\Auth\Database\Administrator::class,
            ],
        ],
    ...
    */
    'database' => [
        ...
        'users_model' => DanSketic\Backport\Auth\Database\Administrator::class,

        // Role table and model.
        'roles_table' => 'backport_roles',
        'roles_model' => DanSketic\Backport\Auth\Database\Role::class,

        // Permission table and model.
        'permissions_table' => 'backport_permissions',
        'permissions_model' => DanSketic\Backport\Auth\Database\Permission::class,

        // Menu table and model.
        'menu_table' => 'backport_menu',
        'menu_model' => DanSketic\Backport\Auth\Database\Menu::class,

        // Pivot table for table above.
        'operation_log_table'    => 'backport_operation_log',
        'user_permissions_table' => 'backport_user_permissions',
        'role_users_table'       => 'backport_role_users',
        'role_permissions_table' => 'backport_role_permissions',
        'role_menu_table'        => 'backport_role_menu',
        'settings_table'         => 'backport_settings',
    ],
